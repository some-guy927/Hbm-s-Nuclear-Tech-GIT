...
public class TileEntityMachineRadarNT extends TileEntityMachineBase implements ITickable, IEnergyUser, IGUIProvider, IConfigurableMachine, IControlReceiver, SimpleComponent, CompatHandler.OCComponent {
