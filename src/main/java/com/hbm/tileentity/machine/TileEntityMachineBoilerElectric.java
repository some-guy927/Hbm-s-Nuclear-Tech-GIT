...
public class TileEntityMachineBoilerElectric extends TileEntityMachineBase implements ITickable, IFluidHandler, IEnergyUser, ITankPacketAcceptor, IGUIProvider {
