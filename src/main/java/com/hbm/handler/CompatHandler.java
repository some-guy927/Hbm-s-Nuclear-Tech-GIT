...
//    }
    ...
    /**
     * This is an interface made specifically for adding OC compatibility to NTM machines. The {@link SimpleComponent} interface must also be implemented in the TE.
     * <br>
     * This interface is not required to be defined as an optional interface, though the {@link SimpleComponent} interface must be declared as an optional interface.
     * <br>
    ...
    public interface OCComponent extends SimpleComponent, SidedComponent, ManagedPeripheral {
        ...
        /**
         * Standard methods array from {@link ManagedPeripheral} extending {@link SimpleComponent}.
        ...
        /**
         * Standard invoke function from {@link ManagedPeripheral} extending {@link SimpleComponent}.
