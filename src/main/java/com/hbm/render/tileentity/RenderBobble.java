...
public class RenderBobble extends TileEntitySpecialRenderer<TileEntityBobble> {
	...
	@Override
	public void render(TileEntityBobble te, double x, double y, double z, float intero, int destroyStage, float alpha) {
		...
		GL11.glRotated(22.5D * te.getBlockMetadata() + 90, 0, -1, 0);
	...
	private ResourceLocation shot_tex = new ResourceLocation(RefStrings.MODID +":textures/models/weapons/ModelUboinik.png");
